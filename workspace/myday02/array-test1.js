...
// 또한 타입이 지정되어 있지 않기 때문에 타입도 동시에 담을 수 있다.
...
// slice(begin, end): 원하는 부분을 추출하기 위해 시작 인덱스(inclusive)와 마지막 인데스(exclusive)를 전달한다.
...
"월화수목금토일".split("").forEach(function(data, i, datOfWeek){
    dayOfWeek[i] = data;
});
// dayOfWeek.push("월");
// dayOfWeek.push("화");
